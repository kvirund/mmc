...
/* hardcoded defaults */
  ...
  { "right","\033OC",	NULL	},
  { "C-up", "\033[1;5A",	NULL	},
  { "C-down", "\033[1;5B",	NULL	},
  { "C-left", "\033[1;5D",	NULL	},
  { "C-right", "\033[1;5C",	NULL	},
  { "S-C-up", "\033[1;6A",	NULL	},
  { "S-C-down", "\033[1;6B",	NULL	},
  { "S-C-left", "\033[1;6D",	NULL	},
  { "S-C-right", "\033[1;6C",	NULL	},
  { "S-up", "\033[1;2A",	NULL	},
  { "S-down", "\033[1;2B",	NULL	},
  { "S-left", "\033[1;2D",	NULL	},
  { "S-right", "\033[1;2C",	NULL	},
  { "M-up", "\033[1;3A",    NULL    },
  { "M-down", "\033[1;3B",  NULL    },
  { "M-left", "\033[1;3D",  NULL    },
  { "M-right", "\033[1;3C", NULL    },
  /* editing keys */
  { "ins",  "\033[2~",	NULL	},
  { "del",  "\177",	NULL	},
  { "del",  "\033[3~",	NULL	},
